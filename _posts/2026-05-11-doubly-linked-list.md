...
<img src="/assets/img/posts/2026-05-11-doubly-linked-list/image1.png" alt="data structure 단일 연결 리스트" width="750">
...
<img src="/assets/img/posts/2026-05-11-doubly-linked-list/image2.png" alt="data structure 이중 연결 리스트" width="750">
...
1. 이전 노드의 **`next`**가 다음 노드를 가리키게 바꾼다.
2. 다음 노드의 **`prev`**가 이전 노드를 가리키게 바꾼다.
...
이전 노드 정보를 가지고 있는 것에 대한 장점은 **탐색**에서도 발휘된다.
...
3. 새로운 노드의 **`next`**가 다음 노드를 가리키게 바꾼다.
4. 다음 노드의 **`prev`**가 새로운 노드를 가리키게 바꾼다.
...
이중 연결 리스트 자료구조를 코드로 구현해보자.

<div style="margin-top: 150px;"></div>

### **Node**
이중 연결 리스트를 구성하는 기본단위인 **`Node`** 클래스
